...
class MyUserAdmin(UserAdmin):
    ...
    fieldsets = (
        ...
        (ugettext_lazy('Personal info'), {'fields': ('first_name', 'last_name', 'email', 'avatar',)}),
    ...
    # add_fieldsets is not a standard ModelAdmin attribute. MyUserAdmin
    # overrides get_fieldsets to use this attribute when creating a user.


def custom_group(obj):
    """
